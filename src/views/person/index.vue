        ...
        <div class="fl-left avatar-box">
          <div class="user-card">
            ...
            <div class="user-personality">
              ...
              <p class="person-info">{{ remark ? remark : '这个家伙很懒，什么都没有留下' }}</p>
            </div>
            <div class="user-information">
              <ul>
                <li>
                  <i class="el-icon-user" />{{ nickName }}
                </li>
                <li>
...
import { setAvator, changePassword } from "@/api/user";
...
export default {
  ...
  computed: {
    ...mapGetters(["id", "nickName", "avatar", "email", "remark"])
  },
  methods: {
    ...
    savePassword() {
      this.$refs.modifyPwdForm.validate(valid => {
        if (valid) {
          changePassword({
            id: this.id,
            password: md5(this.pwdModify.password),
